...
const content = fs.readFileSync(
	path.resolve(__dirname, '../data/spending-2014.csv'), "utf8"
);
...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    */
	...
	return queryInterface.bulkInsert('spending2014', rows, {});
  },
  ...
  down: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkDelete('Spending2014', null, {});
  }
};
