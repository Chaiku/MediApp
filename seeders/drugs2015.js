...
const content = fs.readFileSync(
	path.resolve(__dirname, '../data/spending-2015.csv'), "utf8"
);
...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    */
	...
	return queryInterface.bulkInsert('spending2015', rows, {});
  },
  ...
  down: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkDelete('Spending2015', null, {});
  }
};
