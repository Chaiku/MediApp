...
const content = fs.readFileSync(
	path.resolve(__dirname, '../data/spending-2011.csv'), "utf8"
);
...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    */
	...
	return queryInterface.bulkInsert('spending2011', rows, {});
  },
  ...
  down: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkDelete('Spending2011', null, {});
  }
};
