...
const content = fs.readFileSync(
	path.resolve(__dirname, '../data/spending-2013.csv'), "utf8"
);
...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    */
	...
	return queryInterface.bulkInsert('spending2013', rows, {});
  },
  ...
  down: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkDelete('Spending2013', null, {});
  }
};
